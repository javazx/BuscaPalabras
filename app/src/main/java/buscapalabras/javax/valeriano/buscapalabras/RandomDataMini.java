...
public class RandomDataMini {
    ...
    private final int GRIDTOTAL = 90;
    private final int LETRASBUSCAR = 3;
    int direccionXY;

    public RandomDataMini(){
    ...
    public void setPalabras(ArrayList<String> palabras){
        ...
        for(int i =0; i< LETRASBUSCAR ;i++){
            ...
            int posicionX = randData.nextInt(9);
            int posicionY = randData.nextInt(9);
            ...
            do {
                ...
                sumError = (sumError + 1);
                if(sumError >= 4){
                    posicionX = randData.nextInt(9);
                    posicionY = randData.nextInt(9);
                    sumError = 0;
                }
        ...
        if((y - palabraCount) < 0) {
            ...
            for (int i = 0;i < palabra.length(); i++){
                if(i == 0){
                    ...
                    if(posiciones.contains(posReal - (i * 9))){
                        return "Error";
                    }else{
                        posiciones.add((posReal - (i * 9)));
                    }
                    datos[(posReal - (i * 9))] = String.valueOf(palabra.charAt(i));
                }
            }
        }
        return "OK";
